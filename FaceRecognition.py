...
names = ['', 'Name', 'Name2']  # names, leave first empty bcz counter starts from 0
...
while True:
    ...
    converted_image = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)  # The function converts an input image from one
    ...
    for (x, y, w, h) in faces:
        ...
        colour = (255, 0, 255)
        cv2.rectangle(img, (x, y), (x + w, y + h), colour, rt)
        # Top Left x, y
